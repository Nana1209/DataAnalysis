...
reader = csv.reader(f)
f1 = open('D:\REST API file\\result\\versionLocation-all17444241383502114210.csv','r',newline='')
reader1 = csv.reader(f1)
f7 = open('D:/REST API file/result/versionLocation-cate1.csv', 'w', newline='')
